                ...
                <div className='bg-white rounded p-4'>
                    ...
                    <div className='mt-6 border-t border-gray-100'>
                        <dl className='divide-y divide-gray-100'>
                            <DetailRow title='Full name' detail={`${profile.name.first} ${profile.name.last}`} />
                            <DetailRow title='Age' detail={profile.dob.age.toString()} />
                            ...
                            <DetailRow title='Email Address' detail={profile.email} />
                            <DetailRow title='Date of birth' detail={DateTime.fromISO(profile.dob.date).toFormat('MM/dd/yyyy')} />
                            <DetailRow title='Phone Number' detail={profile.phone} />
                        </dl>
                    </div>
                </div>
            </div>
